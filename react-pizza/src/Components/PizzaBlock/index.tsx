...
import { addItem,CartItems,selectCartItemsById } from "../Redux/Slice/cartSlice";
...
const PizzaBlock:React.FC<pizzaBlockProps> = ({ id, title, price, imageUrl, types,sizes,rating}) => {
  ...
  const addedCount = cartItem ? cartItem.count : 0; //если в корзине нашелся такой тавар то мы из него вытаскиваем count иначе 0 
