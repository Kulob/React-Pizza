...
import { addItem, removeItem, addItemMinus, clearItems, CartItems  } from "./Redux/Slice/cartSlice";
...
const CartItem: React.FC<cartItemProps> = ({id, title, price, size, imageUrl, count, type}) => {
